...
import { JobHistoryAppComponent } from './job-history-app.component';

describe('Component Tests', () => {
  describe('JobHistoryApp Management Component', () => {
    let comp: JobHistoryAppComponent;
    let fixture: ComponentFixture<JobHistoryAppComponent>;
    let service: JobHistoryAppService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [HttpClientTestingModule],
        declarations: [JobHistoryAppComponent],
      })
        .overrideTemplate(JobHistoryAppComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(JobHistoryAppComponent);
